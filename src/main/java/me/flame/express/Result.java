...
public class Result<VALUE, ERROR>  {
    ...
    public static <ERROR extends Exception> @NotNull Result<Void, @NotNull Exception> runThrowing(@NotNull Callabl<@NotNull Exception> runnable) throws AttemptFailedException {
    ...
    public static <ERROR extends Throwable> @NotNull Result<Void, ERROR> runThrowing(
            ...
            @NotNull Callable<@NotNull ERROR> runnable
    ...
    /**
     * @see panda.std.Result#orThrow(me.flame.express.ThrowingFunction)
     */
    @Deprecated
